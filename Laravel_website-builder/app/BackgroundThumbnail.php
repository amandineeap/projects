...
class BackgroundThumbnail extends Model
{
    // define DB elements
    protected $table = 'background_thumbnail';
    protected $primaryKey = 'backgroundThumbnailId'; // removes assumption that primary key is id
    protected $backgroundThumbnailUrl = 'backgroundThumbnailUrl';
