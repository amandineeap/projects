...
class LogoThumbnail extends Model
{
    // define DB elements
    protected $table = 'logo_thumbnail';
    protected $primaryKey = 'logoThumbnailId'; // removes assumption that primary key is id
    protected $logoThumbnailUrl = 'logoThumbnailUrl';
